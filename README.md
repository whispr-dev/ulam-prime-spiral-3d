...
\[!\[Version](https://img.shields.io/badge/version-3.1.1-blue.svg)](https://github.com/whisprer/ulam-prime-spiral-3d) 
...
&nbsp; <img src="./assets/ulam-prime-spiral-3d-banner-1mb.png" width="850" alt="ulam-prime-spiral-3d Banner">
...
python ulam3d\_wow.py --N 20000 --mapping shell --topk 12
...
python ulam3d\_wow.py --N 100000 --mapping shell --dir-max 2 --min-line-primes 7 --topk 20
...
python ulam3d\_wow.py --N 60000 --mapping surface --topk 16
...
&nbsp; --export-prefix ulam3d\_shell\_50k
...
`ulam3d\_shell\_50k.ply`

`ulam3d\_shell\_50k.obj`

`ulam3d\_shell\_50k.gltf`

`ulam3d\_shell\_50k.bin`
...
\[!\[Surface-traversal primes](./assets/surface\_50k.png)](./assets/surface\_50k.png)



\## Comparison

<img src="./assets/shell\_50k.png" width="48%" alt="Shell mapping">

<img src="./assets/surface\_50k.png" width="48%" alt="Surface mapping">
